...
// NodeClaim being evaluated. Only in-cluster (non-potential) slices are supported; potential slices indicate a
// programming error. nodeName is the name of the concrete node backing the NodeClaim, or "" for in-flight/new
// NodeClaims that don't yet have a node.
//
